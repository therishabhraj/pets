...
//            Insert Mode
            ...
            if (newUri == null){
                ...
                Toast.makeText(this, "Pet Successfully Inserted", Toast.LENGTH_LONG).show();
            }
...
//            Update Mode
            ...
            if (rowsAffected == 0){
                Toast.makeText(this, "Error Updating to Database", Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(this, "Pet Successfully Updated", Toast.LENGTH_LONG).show();
            }
        }
    }
